...
public class MyHashMapTest {
    ...
    //UC3 remove key from Linked list
    @Test
    public void giveASentence_ShouldRemoveGivenFrequencyOfWordFromLinkedListPassTheResult() {
        String sentence = "Paranoids are not paranoid because they are paranoid " + "but because they keep putting themselves deliberately" + " into paranoid avoidable situations";
        MyLinkedHashMap<String, Integer> myLinkedHashMap = new MyLinkedHashMap<>();
        String[] words = sentence.toLowerCase().split(" ");
        for (String word : words) {
        ...
        System.out.println(myLinkedHashMap.getBucketIndex("avoidable"));
        System.out.println(myLinkedHashMap.get("avoidable"));
